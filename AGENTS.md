# Headless, Tailwind-native calendar/scheduler library with free resource-timeline views (`headless-scheduler`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://headless-scheduler.sociobot.in`. Artifact class: `library-npm`.
